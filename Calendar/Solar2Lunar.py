...
def get_days_of_lyear(syear, smonth, sday):
    ...
    if ((spring_month > smonth) or ((spring_month == smonth) and (spring_day > sday))):
        ...
        lyear -= 1
        lunar_days = get_syear_days(lyear) + get_days_of_syear(syear, smonth, sday) - get_days_of_syear(lyear, spring_month, spring_day)
    else:
        lunar_days = get_days_of_syear(syear, smonth, sday)  -    get_days_of_syear(syear, spring_month, spring_day)
...
if __name__ == "__main__":
        y,m,d = 2016, 11, 26
        print "Sun calendar 2016-11-26 == Lunar calendar ",    get_lunar_date(y,m,d) 
